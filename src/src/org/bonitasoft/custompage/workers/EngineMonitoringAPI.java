...
public class EngineMonitoringAPI {
  ...
  public static Map<String, Object> getListNameRadars() {
    ...
    map.put("radars", radarFactory.getListRadar());
    return map;
  }
   ...
   * @return
   */
  public static Map<String, Object> getAllPhoto() {
    Map<String, Object> map = new HashMap<String, Object>();
    long timeBegin = System.currentTimeMillis();

    List<Map<String, Object>> listRadarsPhoto = new ArrayList<Map<String, Object>>();
    RadarFactory radarFactory = RadarFactory.getinstance();
    for (String radarName : radarFactory.getListRadar()) {
      Radar radar = radarFactory.getRadar(radarName);
      List<RadarPhoto> listRadarPhotos = radar.takePhoto();

      Map<String, Object> radarMap = radar.getMap();
      List<Map<String, Object>> listPhotos = new ArrayList<Map<String, Object>>();
      for (RadarPhoto photo : listRadarPhotos) {
